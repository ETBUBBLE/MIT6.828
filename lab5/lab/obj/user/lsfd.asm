	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800263:	e8 58 1c 00 00       	call   801ec0 <__udivdi3>
  ...
  8002a6:	e8 45 1d 00 00       	call   801ff0 <__umoddi3>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801512:	e8 32 09 00 00       	call   801e49 <ipc_find_env>
  ...
  80152d:	e8 c3 08 00 00       	call   801df5 <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8018fb:	e8 82 05 00 00       	call   801e82 <pageref>
  801900:	89 c3                	mov    %eax,%ebx
  801902:	89 3c 24             	mov    %edi,(%esp)
  801905:	e8 78 05 00 00       	call   801e82 <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d9c:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801da1:	0f 44 c2             	cmove  %edx,%eax
    int r;
    if ((r = sys_ipc_recv(pg)) < 0) {
  801da4:	83 ec 0c             	sub    $0xc,%esp
  801da7:	50                   	push   %eax
  801da8:	e8 0a f0 ff ff       	call   800db7 <sys_ipc_recv>
  801dad:	83 c4 10             	add    $0x10,%esp
  801db0:	85 c0                	test   %eax,%eax
  801db2:	79 16                	jns    801dca <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801db4:	85 f6                	test   %esi,%esi
  801db6:	74 06                	je     801dbe <ipc_recv+0x32>
            *from_env_store = 0;
  801db8:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801dbe:	85 db                	test   %ebx,%ebx
  801dc0:	74 2c                	je     801dee <ipc_recv+0x62>
            *perm_store = 0;
  801dc2:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801dc8:	eb 24                	jmp    801dee <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801dca:	85 f6                	test   %esi,%esi
  801dcc:	74 0a                	je     801dd8 <ipc_recv+0x4c>
  ...
  801dda:	74 0a                	je     801de6 <ipc_recv+0x5a>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e09:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801e0e:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801e11:	eb 1c                	jmp    801e2f <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801e13:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e16:	74 12                	je     801e2a <ipc_send+0x35>
  801e18:	50                   	push   %eax
  801e19:	68 dc 25 80 00       	push   $0x8025dc
  801e1e:	6a 3a                	push   $0x3a
  801e20:	68 f2 25 80 00       	push   $0x8025f2
  801e25:	e8 1c ff ff ff       	call   801d46 <_panic>
		sys_yield();
  801e2a:	e8 b9 ed ff ff       	call   800be8 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801e33:	56                   	push   %esi
  801e34:	57                   	push   %edi
  801e35:	e8 5a ef ff ff       	call   800d94 <sys_ipc_try_send>
  801e3a:	83 c4 10             	add    $0x10,%esp
  801e3d:	85 c0                	test   %eax,%eax
  801e3f:	78 d2                	js     801e13 <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e54:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801e57:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801e5d:	8b 52 50             	mov    0x50(%edx),%edx
  801e60:	39 ca                	cmp    %ecx,%edx
  801e62:	75 0d                	jne    801e71 <ipc_find_env+0x28>
			return envs[i].env_id;
  801e64:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e67:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801e6c:	8b 40 48             	mov    0x48(%eax),%eax
  801e6f:	eb 0f                	jmp    801e80 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e74:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e79:	75 d9                	jne    801e54 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801e8a:	c1 e8 16             	shr    $0x16,%eax
  801e8d:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e99:	f6 c1 01             	test   $0x1,%cl
  801e9c:	74 1d                	je     801ebb <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  801eab:	74 0e                	je     801ebb <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801ead:	c1 ea 0c             	shr    $0xc,%edx
  801eb0:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801eb7:	ef 
  801eb8:	0f b7 c0             	movzwl %ax,%eax
}
  801ebb:	5d                   	pop    %ebp
  801ebc:	c3                   	ret    
