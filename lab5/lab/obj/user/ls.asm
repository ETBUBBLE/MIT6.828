...
fsipc(unsigned type, void *dstva)
{
  ...
  80170f:	e8 ec 08 00 00       	call   802000 <ipc_find_env>
  ...
  80172a:	e8 7d 08 00 00       	call   801fac <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801af8:	e8 3c 05 00 00       	call   802039 <pageref>
  801afd:	89 c3                	mov    %eax,%ebx
  801aff:	89 3c 24             	mov    %edi,(%esp)
  801b02:	e8 32 05 00 00       	call   802039 <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f5e:	50                   	push   %eax
  801f5f:	e8 50 f0 ff ff       	call   800fb4 <sys_ipc_recv>
  ...
  801f93:	a1 20 44 80 00       	mov    0x804420,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801fc0:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801fc5:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
  ...
  801fcf:	50                   	push   %eax
  801fd0:	68 fa 27 80 00       	push   $0x8027fa
  801fd5:	6a 3a                	push   $0x3a
  801fd7:	68 10 28 80 00       	push   $0x802810
  801fdc:	e8 43 e3 ff ff       	call   800324 <_panic>
		sys_yield();
  801fe1:	e8 ff ed ff ff       	call   800de5 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801fea:	56                   	push   %esi
  801feb:	57                   	push   %edi
  801fec:	e8 a0 ef ff ff       	call   800f91 <sys_ipc_try_send>
...
ipc_find_env(enum EnvType type)
{
  ...
  80201e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  802023:	8b 40 48             	mov    0x48(%eax),%eax
  802026:	eb 0f                	jmp    802037 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
...
pageref(void *v)
{
  ...
  802041:	c1 e8 16             	shr    $0x16,%eax
  802044:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  802050:	f6 c1 01             	test   $0x1,%cl
  802053:	74 1d                	je     802072 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  802055:	c1 ea 0c             	shr    $0xc,%edx
  802058:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  80205f:	f6 c2 01             	test   $0x1,%dl
  802062:	74 0e                	je     802072 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  802064:	c1 ea 0c             	shr    $0xc,%edx
  802067:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  80206e:	ef 
  80206f:	0f b7 c0             	movzwl %ax,%eax
}
  802072:	5d                   	pop    %ebp
  802073:	c3                   	ret    
