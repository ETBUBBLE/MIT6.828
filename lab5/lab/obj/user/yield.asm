...
fsipc(unsigned type, void *dstva)
{
  ...
  80134b:	e8 22 08 00 00       	call   801b72 <ipc_find_env>
  ...
  801366:	e8 b3 07 00 00       	call   801b1e <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801624:	e8 82 05 00 00       	call   801bab <pageref>
  801629:	89 c3                	mov    %eax,%ebx
  80162b:	89 3c 24             	mov    %edi,(%esp)
  80162e:	e8 78 05 00 00       	call   801bab <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ad0:	50                   	push   %eax
  801ad1:	e8 6e f2 ff ff       	call   800d44 <sys_ipc_recv>
  801ad6:	83 c4 10             	add    $0x10,%esp
  801ad9:	85 c0                	test   %eax,%eax
  801adb:	79 16                	jns    801af3 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801add:	85 f6                	test   %esi,%esi
  801adf:	74 06                	je     801ae7 <ipc_recv+0x32>
            *from_env_store = 0;
  801ae1:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801ae7:	85 db                	test   %ebx,%ebx
  801ae9:	74 2c                	je     801b17 <ipc_recv+0x62>
            *perm_store = 0;
  801aeb:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801af1:	eb 24                	jmp    801b17 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801af3:	85 f6                	test   %esi,%esi
  801af5:	74 0a                	je     801b01 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801af7:	a1 04 40 80 00       	mov    0x804004,%eax
  801afc:	8b 40 74             	mov    0x74(%eax),%eax
  801aff:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801b01:	85 db                	test   %ebx,%ebx
  801b03:	74 0a                	je     801b0f <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801b05:	a1 04 40 80 00       	mov    0x804004,%eax
  801b0a:	8b 40 78             	mov    0x78(%eax),%eax
  801b0d:	89 03                	mov    %eax,(%ebx)
    return thisenv->env_ipc_value;
  801b0f:	a1 04 40 80 00       	mov    0x804004,%eax
  801b14:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b37:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801b3a:	eb 1c                	jmp    801b58 <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801b3c:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b3f:	74 12                	je     801b53 <ipc_send+0x35>
  801b41:	50                   	push   %eax
  801b42:	68 3c 23 80 00       	push   $0x80233c
  801b47:	6a 3a                	push   $0x3a
  801b49:	68 52 23 80 00       	push   $0x802352
  801b4e:	e8 1c ff ff ff       	call   801a6f <_panic>
		sys_yield();
  801b53:	e8 1d f0 ff ff       	call   800b75 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801b5c:	56                   	push   %esi
  801b5d:	57                   	push   %edi
  801b5e:	e8 be f1 ff ff       	call   800d21 <sys_ipc_try_send>
  801b63:	83 c4 10             	add    $0x10,%esp
  801b66:	85 c0                	test   %eax,%eax
  801b68:	78 d2                	js     801b3c <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b7d:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801b80:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b86:	8b 52 50             	mov    0x50(%edx),%edx
  801b89:	39 ca                	cmp    %ecx,%edx
  801b8b:	75 0d                	jne    801b9a <ipc_find_env+0x28>
			return envs[i].env_id;
  801b8d:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b90:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b95:	8b 40 48             	mov    0x48(%eax),%eax
  801b98:	eb 0f                	jmp    801ba9 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b9d:	3d 00 04 00 00       	cmp    $0x400,%eax
  801ba2:	75 d9                	jne    801b7d <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801bb3:	c1 e8 16             	shr    $0x16,%eax
  801bb6:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801bc2:	f6 c1 01             	test   $0x1,%cl
  801bc5:	74 1d                	je     801be4 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801bc7:	c1 ea 0c             	shr    $0xc,%edx
  801bca:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801bd1:	f6 c2 01             	test   $0x1,%dl
  801bd4:	74 0e                	je     801be4 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801bd6:	c1 ea 0c             	shr    $0xc,%edx
  801bd9:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801be0:	ef 
  801be1:	0f b7 c0             	movzwl %ax,%eax
}
  801be4:	5d                   	pop    %ebp
  801be5:	c3                   	ret    
