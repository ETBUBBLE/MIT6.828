...
fsipc(unsigned type, void *dstva)
{
  ...
  8014d2:	e8 dc 07 00 00       	call   801cb3 <ipc_find_env>
  ...
  8014ed:	e8 6d 07 00 00       	call   801c5f <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8017ab:	e8 3c 05 00 00       	call   801cec <pageref>
  8017b0:	89 c3                	mov    %eax,%ebx
  8017b2:	89 3c 24             	mov    %edi,(%esp)
  8017b5:	e8 32 05 00 00       	call   801cec <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c06:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801c0b:	0f 44 c2             	cmove  %edx,%eax
    int r;
    if ((r = sys_ipc_recv(pg)) < 0) {
  801c0e:	83 ec 0c             	sub    $0xc,%esp
  801c11:	50                   	push   %eax
  801c12:	e8 b4 f2 ff ff       	call   800ecb <sys_ipc_recv>
  801c17:	83 c4 10             	add    $0x10,%esp
  801c1a:	85 c0                	test   %eax,%eax
  801c1c:	79 16                	jns    801c34 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801c1e:	85 f6                	test   %esi,%esi
  801c20:	74 06                	je     801c28 <ipc_recv+0x32>
            *from_env_store = 0;
  801c22:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801c28:	85 db                	test   %ebx,%ebx
  801c2a:	74 2c                	je     801c58 <ipc_recv+0x62>
            *perm_store = 0;
  801c2c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801c32:	eb 24                	jmp    801c58 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801c34:	85 f6                	test   %esi,%esi
  801c36:	74 0a                	je     801c42 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801c38:	a1 04 40 80 00       	mov    0x804004,%eax
  801c3d:	8b 40 74             	mov    0x74(%eax),%eax
  801c40:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801c42:	85 db                	test   %ebx,%ebx
  801c44:	74 0a                	je     801c50 <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801c46:	a1 04 40 80 00       	mov    0x804004,%eax
  801c4b:	8b 40 78             	mov    0x78(%eax),%eax
  801c4e:	89 03                	mov    %eax,(%ebx)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c6b:	8b 75 0c             	mov    0xc(%ebp),%esi
  801c6e:	8b 45 10             	mov    0x10(%ebp),%eax
  801c71:	85 c0                	test   %eax,%eax
  801c73:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801c78:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801c7b:	eb 1c                	jmp    801c99 <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801c7d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c80:	74 12                	je     801c94 <ipc_send+0x35>
  801c82:	50                   	push   %eax
  801c83:	68 9a 24 80 00       	push   $0x80249a
  801c88:	6a 3a                	push   $0x3a
  801c8a:	68 b0 24 80 00       	push   $0x8024b0
  801c8f:	e8 a7 e5 ff ff       	call   80023b <_panic>
		sys_yield();
  801c94:	e8 63 f0 ff ff       	call   800cfc <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801c9d:	56                   	push   %esi
  801c9e:	57                   	push   %edi
  801c9f:	e8 04 f2 ff ff       	call   800ea8 <sys_ipc_try_send>
  801ca4:	83 c4 10             	add    $0x10,%esp
  801ca7:	85 c0                	test   %eax,%eax
  801ca9:	78 d2                	js     801c7d <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801ce3:	75 d9                	jne    801cbe <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801cf4:	c1 e8 16             	shr    $0x16,%eax
  801cf7:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801d03:	f6 c1 01             	test   $0x1,%cl
  801d06:	74 1d                	je     801d25 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801d08:	c1 ea 0c             	shr    $0xc,%edx
  801d0b:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801d12:	f6 c2 01             	test   $0x1,%dl
  801d15:	74 0e                	je     801d25 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d17:	c1 ea 0c             	shr    $0xc,%edx
  801d1a:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801d21:	ef 
  801d22:	0f b7 c0             	movzwl %ax,%eax
}
  801d25:	5d                   	pop    %ebp
  801d26:	c3                   	ret    
