...
exit(void)
{
  ...
  8005e0:	83 ec 08             	sub    $0x8,%esp
	close_all();
  8005e3:	e8 32 0f 00 00       	call   80151a <close_all>
	sys_env_destroy(0);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800733:	e8 38 1a 00 00       	call   802170 <__udivdi3>
  ...
  800776:	e8 25 1b 00 00       	call   8022a0 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80092d:	52                   	push   %edx
  80092e:	68 39 29 80 00       	push   $0x802939
  800933:	53                   	push   %ebx
  800934:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  801080:	68 3f 28 80 00       	push   $0x80283f
  801085:	6a 23                	push   $0x23
  801087:	68 5c 28 80 00       	push   $0x80285c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  801101:	68 3f 28 80 00       	push   $0x80283f
  801106:	6a 23                	push   $0x23
  801108:	68 5c 28 80 00       	push   $0x80285c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  801143:	68 3f 28 80 00       	push   $0x80283f
  801148:	6a 23                	push   $0x23
  80114a:	68 5c 28 80 00       	push   $0x80285c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801185:	68 3f 28 80 00       	push   $0x80283f
  80118a:	6a 23                	push   $0x23
  80118c:	68 5c 28 80 00       	push   $0x80285c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8011c7:	68 3f 28 80 00       	push   $0x80283f
  8011cc:	6a 23                	push   $0x23
  8011ce:	68 5c 28 80 00       	push   $0x80285c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80124b:	68 3f 28 80 00       	push   $0x80283f
  801250:	6a 23                	push   $0x23
  801252:	68 5c 28 80 00       	push   $0x80285c
...
sys_ipc_recv(void *dstva)
{
  ...
  8012af:	68 3f 28 80 00       	push   $0x80283f
  8012b4:	6a 23                	push   $0x23
  8012b6:	68 5c 28 80 00       	push   $0x80285c
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012ce:	83 3d b4 40 80 00 00 	cmpl   $0x0,0x8040b4
  8012d5:	75 4a                	jne    801321 <set_pgfault_handler+0x59>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP - PGSIZE), PTE_P | PTE_W | PTE_U)) < 0)
  8012d7:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  ...
  8012f6:	50                   	push   %eax
  8012f7:	68 6a 28 80 00       	push   $0x80286a
  8012fc:	6a 21                	push   $0x21
  8012fe:	68 82 28 80 00       	push   $0x802882
  801303:	e8 ef f2 ff ff       	call   8005f7 <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801308:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  80130d:	8b 40 48             	mov    0x48(%eax),%eax
  801310:	83 ec 08             	sub    $0x8,%esp
  801313:	68 2b 13 80 00       	push   $0x80132b
  801318:	50                   	push   %eax
  ...
  801324:	a3 b4 40 80 00       	mov    %eax,0x8040b4
  801329:	c9                   	leave  
  80132a:	c3                   	ret    

0080132b <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80132c:	a1 b4 40 80 00       	mov    0x8040b4,%eax
	call *%eax
  ...
  801336:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  801339:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  80133d:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  801342:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
...
fd_alloc(struct Fd **fd_store)
{
  ...
  801390:	74 11                	je     8013a3 <fd_alloc+0x2d>
  ...
  8013a1:	75 09                	jne    8013ac <fd_alloc+0x36>
			*fd_store = fd;
  8013a3:	89 01                	mov    %eax,(%ecx)
			return 0;
  8013a5:	b8 00 00 00 00       	mov    $0x0,%eax
  8013aa:	eb 17                	jmp    8013c3 <fd_alloc+0x4d>
...
fd_alloc(struct Fd **fd_store)
{
  ...
  8013b6:	75 c9                	jne    801381 <fd_alloc+0xb>
		if ((uvpd[PDX(fd)] & PTE_P) == 0 || (uvpt[PGNUM(fd)] & PTE_P) == 0) {
			*fd_store = fd;
			return 0;
		}
	...
	*fd_store = 0;
  8013b8:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
	return -E_MAX_OPEN;
...
fd_lookup(int fdnum, struct Fd **fd_store)
{
  ...
  8013ce:	77 36                	ja     801406 <fd_lookup+0x41>
		if (debug)
  ...
  8013e7:	74 24                	je     80140d <fd_lookup+0x48>
  ...
  8013f8:	74 1a                	je     801414 <fd_lookup+0x4f>
		if (debug)
  ...
  8013fd:	89 02                	mov    %eax,(%edx)
	return 0;
  8013ff:	b8 00 00 00 00       	mov    $0x0,%eax
  801404:	eb 13                	jmp    801419 <fd_lookup+0x54>
	struct Fd *fd;
  ...
  80140b:	eb 0c                	jmp    801419 <fd_lookup+0x54>
	}
	fd = INDEX2FD(fdnum);
	if (!(uvpd[PDX(fd)] & PTE_P) || !(uvpt[PGNUM(fd)] & PTE_P)) {
		if (debug)
  ...
  801412:	eb 05                	jmp    801419 <fd_lookup+0x54>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801424:	ba 10 29 80 00       	mov    $0x802910,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  801429:	eb 13                	jmp    80143e <dev_lookup+0x23>
  80142b:	83 c2 04             	add    $0x4,%edx
		if (devtab[i]->dev_id == dev_id) {
  80142e:	39 08                	cmp    %ecx,(%eax)
  801430:	75 0c                	jne    80143e <dev_lookup+0x23>
			*dev = devtab[i];
  801432:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801435:	89 01                	mov    %eax,(%ecx)
			return 0;
  801437:	b8 00 00 00 00       	mov    $0x0,%eax
  80143c:	eb 2e                	jmp    80146c <dev_lookup+0x51>
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  80143e:	8b 02                	mov    (%edx),%eax
  801440:	85 c0                	test   %eax,%eax
  801442:	75 e7                	jne    80142b <dev_lookup+0x10>
		if (devtab[i]->dev_id == dev_id) {
			*dev = devtab[i];
			return 0;
		}
	cprintf("[%08x] unknown device type %d\n", thisenv->env_id, dev_id);
  801444:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801449:	8b 40 48             	mov    0x48(%eax),%eax
  80144c:	83 ec 04             	sub    $0x4,%esp
  80144f:	51                   	push   %ecx
  801450:	50                   	push   %eax
  801451:	68 90 28 80 00       	push   $0x802890
  801456:	e8 75 f2 ff ff       	call   8006d0 <cprintf>
	*dev = 0;
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  801489:	50                   	push   %eax
  80148a:	e8 36 ff ff ff       	call   8013c5 <fd_lookup>
  ...
  8014b0:	e8 66 ff ff ff       	call   80141b <dev_lookup>
  ...
  8014de:	e8 79 fc ff ff       	call   80115c <sys_page_unmap>
	return r;
...
close(int fdnum)
{
  ...
  8014fc:	e8 c4 fe ff ff       	call   8013c5 <fd_lookup>
...
dup(int oldfdnum, int newfdnum)
{
  ...
  801552:	e8 6e fe ff ff       	call   8013c5 <fd_lookup>
  ...
  80157c:	e8 de fd ff ff       	call   80135f <fd2data>
  801581:	89 c7                	mov    %eax,%edi
	nva = fd2data(newfd);
  801583:	89 1c 24             	mov    %ebx,(%esp)
  801586:	e8 d4 fd ff ff       	call   80135f <fd2data>
  ...
  8015ca:	e8 4b fb ff ff       	call   80111a <sys_page_map>
  ...
  8015f6:	e8 1f fb ff ff       	call   80111a <sys_page_map>
...
err:
  ...
  80160c:	e8 4b fb ff ff       	call   80115c <sys_page_unmap>
	sys_page_unmap(0, nva);
  801611:	83 c4 08             	add    $0x8,%esp
  801614:	ff 75 d4             	pushl  -0x2c(%ebp)
  801617:	6a 00                	push   $0x0
  801619:	e8 3e fb ff ff       	call   80115c <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801654:	e8 c2 fd ff ff       	call   80141b <dev_lookup>
  801659:	83 c4 10             	add    $0x10,%esp
  80165c:	85 c0                	test   %eax,%eax
  80165e:	78 4c                	js     8016ac <read+0x81>
		return r;
  ...
  8016a2:	52                   	push   %edx
  8016a3:	ff d0                	call   *%eax
  8016a5:	89 c2                	mov    %eax,%edx
  8016a7:	83 c4 10             	add    $0x10,%esp
  8016aa:	eb 09                	jmp    8016b5 <read+0x8a>
	int r;
	struct Dev *dev;
	struct Fd *fd;
  ...
  8016ae:	eb 05                	jmp    8016b5 <read+0x8a>
	if ((fd->fd_omode & O_ACCMODE) == O_WRONLY) {
		cprintf("[%08x] read %d -- bad mode\n", thisenv->env_id, fdnum);
		return -E_INVAL;
	}
...
readn(int fdnum, void *buf, size_t n)
{
  ...
  8016f3:	39 f3                	cmp    %esi,%ebx
  8016f5:	72 db                	jb     8016d2 <readn+0x16>
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801712:	50                   	push   %eax
  801713:	53                   	push   %ebx
  801714:	e8 ac fc ff ff       	call   8013c5 <fd_lookup>
  801719:	83 c4 08             	add    $0x8,%esp
  80171c:	89 c2                	mov    %eax,%edx
  80171e:	85 c0                	test   %eax,%eax
  801720:	78 68                	js     80178a <write+0x85>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  80172e:	e8 e8 fc ff ff       	call   80141b <dev_lookup>
  801733:	83 c4 10             	add    $0x10,%esp
  801736:	85 c0                	test   %eax,%eax
  801738:	78 47                	js     801781 <write+0x7c>
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  80173a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80173d:	f6 40 08 03          	testb  $0x3,0x8(%eax)
  801741:	75 21                	jne    801764 <write+0x5f>
		cprintf("[%08x] write %d -- bad mode\n", thisenv->env_id, fdnum);
  801743:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801748:	8b 40 48             	mov    0x48(%eax),%eax
  80174b:	83 ec 04             	sub    $0x4,%esp
  80174e:	53                   	push   %ebx
  80174f:	50                   	push   %eax
  801750:	68 f0 28 80 00       	push   $0x8028f0
  801755:	e8 76 ef ff ff       	call   8006d0 <cprintf>
		return -E_INVAL;
  80175a:	83 c4 10             	add    $0x10,%esp
  80175d:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
  801762:	eb 26                	jmp    80178a <write+0x85>
	}
	if (debug)
  ...
  80176c:	74 17                	je     801785 <write+0x80>
		return -E_NOT_SUPP;
  ...
  80177f:	eb 09                	jmp    80178a <write+0x85>
	int r;
	struct Dev *dev;
	struct Fd *fd;
  ...
  801783:	eb 05                	jmp    80178a <write+0x85>
	}
	if (debug)
		cprintf("write %d %p %d via dev %s\n",
			fdnum, buf, n, dev->dev_name);
	if (!dev->dev_write)
		return -E_NOT_SUPP;
  801785:	ba f1 ff ff ff       	mov    $0xfffffff1,%edx
	return (*dev->dev_write)(fd, buf, n);
}
...
seek(int fdnum, off_t offset)
{
  ...
  801794:	83 ec 10             	sub    $0x10,%esp
	...
	if ((r = fd_lookup(fdnum, &fd)) < 0)
  801797:	8d 45 fc             	lea    -0x4(%ebp),%eax
  80179a:	50                   	push   %eax
  80179b:	ff 75 08             	pushl  0x8(%ebp)
  80179e:	e8 22 fc ff ff       	call   8013c5 <fd_lookup>
  8017a3:	83 c4 08             	add    $0x8,%esp
  8017a6:	85 c0                	test   %eax,%eax
  8017a8:	78 0e                	js     8017b8 <seek+0x27>
		return r;
	fd->fd_offset = offset;
  8017aa:	8b 45 fc             	mov    -0x4(%ebp),%eax
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8017c7:	50                   	push   %eax
  8017c8:	53                   	push   %ebx
  8017c9:	e8 f7 fb ff ff       	call   8013c5 <fd_lookup>
  8017ce:	83 c4 08             	add    $0x8,%esp
  8017d1:	89 c2                	mov    %eax,%edx
  8017d3:	85 c0                	test   %eax,%eax
  8017d5:	78 65                	js     80183c <ftruncate+0x82>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  8017e3:	e8 33 fc ff ff       	call   80141b <dev_lookup>
  8017e8:	83 c4 10             	add    $0x10,%esp
  8017eb:	85 c0                	test   %eax,%eax
  8017ed:	78 44                	js     801833 <ftruncate+0x79>
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
  8017ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017f2:	f6 40 08 03          	testb  $0x3,0x8(%eax)
  8017f6:	75 21                	jne    801819 <ftruncate+0x5f>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8017f8:	a1 b0 40 80 00       	mov    0x8040b0,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
	if ((fd->fd_omode & O_ACCMODE) == O_RDONLY) {
		cprintf("[%08x] ftruncate %d -- bad mode\n",
  8017fd:	8b 40 48             	mov    0x48(%eax),%eax
  801800:	83 ec 04             	sub    $0x4,%esp
  801803:	53                   	push   %ebx
  801804:	50                   	push   %eax
  801805:	68 b0 28 80 00       	push   $0x8028b0
  80180a:	e8 c1 ee ff ff       	call   8006d0 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
  80180f:	83 c4 10             	add    $0x10,%esp
  801812:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
  801817:	eb 23                	jmp    80183c <ftruncate+0x82>
	}
	if (!dev->dev_trunc)
  801819:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80181c:	8b 52 18             	mov    0x18(%edx),%edx
  80181f:	85 d2                	test   %edx,%edx
  801821:	74 14                	je     801837 <ftruncate+0x7d>
		return -E_NOT_SUPP;
  ...
  801831:	eb 09                	jmp    80183c <ftruncate+0x82>
{
	int r;
	struct Dev *dev;
	struct Fd *fd;
  ...
  801835:	eb 05                	jmp    80183c <ftruncate+0x82>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
		return -E_INVAL;
	}
...
fstat(int fdnum, struct Stat *stat)
{
  ...
  801854:	e8 6c fb ff ff       	call   8013c5 <fd_lookup>
  801859:	83 c4 08             	add    $0x8,%esp
  80185c:	89 c2                	mov    %eax,%edx
  80185e:	85 c0                	test   %eax,%eax
  801860:	78 58                	js     8018ba <fstat+0x77>
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
  ...
  80186e:	e8 a8 fb ff ff       	call   80141b <dev_lookup>
  801873:	83 c4 10             	add    $0x10,%esp
  801876:	85 c0                	test   %eax,%eax
  801878:	78 37                	js     8018b1 <fstat+0x6e>
		return r;
	if (!dev->dev_stat)
  80187a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80187d:	83 78 14 00          	cmpl   $0x0,0x14(%eax)
  801881:	74 32                	je     8018b5 <fstat+0x72>
		return -E_NOT_SUPP;
	stat->st_name[0] = 0;
  ...
  8018af:	eb 09                	jmp    8018ba <fstat+0x77>
	int r;
	struct Dev *dev;
	struct Fd *fd;
  ...
  8018b3:	eb 05                	jmp    8018ba <fstat+0x77>
		return r;
	if (!dev->dev_stat)
		return -E_NOT_SUPP;
...
stat(const char *path, struct Stat *stat)
{
  ...
  8018ce:	e8 e3 01 00 00       	call   801ab6 <open>
  ...
  8018e2:	50                   	push   %eax
  8018e3:	e8 5b ff ff ff       	call   801843 <fstat>
  8018e8:	89 c6                	mov    %eax,%esi
	close(fd);
  8018ea:	89 1c 24             	mov    %ebx,(%esp)
  8018ed:	e8 fd fb ff ff       	call   8014ef <close>
	return r;
...
fsipc(unsigned type, void *dstva)
{
  ...
  801905:	89 d3                	mov    %edx,%ebx
	static envid_t fsenv;
	if (fsenv == 0)
  801907:	83 3d ac 40 80 00 00 	cmpl   $0x0,0x8040ac
  80190e:	75 12                	jne    801922 <fsipc+0x24>
		fsenv = ipc_find_env(ENV_TYPE_FS);
  801910:	83 ec 0c             	sub    $0xc,%esp
  801913:	6a 01                	push   $0x1
  801915:	e8 dc 07 00 00       	call   8020f6 <ipc_find_env>
  ...
  801929:	56                   	push   %esi
  80192a:	ff 35 ac 40 80 00    	pushl  0x8040ac
  801930:	e8 6d 07 00 00       	call   8020a2 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801935:	83 c4 0c             	add    $0xc,%esp
  801938:	6a 00                	push   $0x0
  80193a:	53                   	push   %ebx
  80193b:	6a 00                	push   $0x0
  80193d:	e8 f7 06 00 00       	call   802039 <ipc_recv>
}
...
devfile_trunc(struct Fd *fd, off_t newsize)
{
  ...
  80196c:	e8 8d ff ff ff       	call   8018fe <fsipc>
}
  801971:	c9                   	leave  
  801972:	c3                   	ret    
...
devfile_flush(struct Fd *fd)
{
  ...
  80198e:	e8 6b ff ff ff       	call   8018fe <fsipc>
}
  801993:	c9                   	leave  
  801994:	c3                   	ret    
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  8019b4:	e8 45 ff ff ff       	call   8018fe <fsipc>
  8019b9:	85 c0                	test   %eax,%eax
  8019bb:	78 2c                	js     8019e9 <devfile_stat+0x54>
		return r;
	strcpy(st->st_name, fsipcbuf.statRet.ret_name);
  8019bd:	83 ec 08             	sub    $0x8,%esp
  8019c0:	68 00 50 80 00       	push   $0x805000
  8019c5:	53                   	push   %ebx
  8019c6:	e8 09 f3 ff ff       	call   800cd4 <strcpy>
	st->st_size = fsipcbuf.statRet.ret_size;
  8019cb:	a1 80 50 80 00       	mov    0x805080,%eax
  8019d0:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	st->st_isdir = fsipcbuf.statRet.ret_isdir;
  8019d6:	a1 84 50 80 00       	mov    0x805084,%eax
  8019db:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
	return 0;
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8019f7:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8019fc:	ba f8 0f 00 00       	mov    $0xff8,%edx
  801a01:	0f 47 c2             	cmova  %edx,%eax
  ...
  801a07:	8b 52 0c             	mov    0xc(%edx),%edx
  801a0a:	89 15 00 50 80 00    	mov    %edx,0x805000
  ...
  801a1e:	e8 43 f4 ff ff       	call   800e66 <memmove>
	return fsipc(FSREQ_WRITE, NULL);
  801a23:	ba 00 00 00 00       	mov    $0x0,%edx
  801a28:	b8 04 00 00 00       	mov    $0x4,%eax
  801a2d:	e8 cc fe ff ff       	call   8018fe <fsipc>
	//panic("devfile_write not implemented");
}
  801a32:	c9                   	leave  
  801a33:	c3                   	ret    
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801a57:	e8 a2 fe ff ff       	call   8018fe <fsipc>
  ...
  801a66:	68 20 29 80 00       	push   $0x802920
  801a6b:	68 27 29 80 00       	push   $0x802927
  801a70:	6a 7c                	push   $0x7c
  801a72:	68 3c 29 80 00       	push   $0x80293c
  801a77:	e8 7b eb ff ff       	call   8005f7 <_panic>
	assert(r <= PGSIZE);
  801a7c:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801a81:	7e 16                	jle    801a99 <devfile_read+0x65>
  801a83:	68 47 29 80 00       	push   $0x802947
  801a88:	68 27 29 80 00       	push   $0x802927
  801a8d:	6a 7d                	push   $0x7d
  801a8f:	68 3c 29 80 00       	push   $0x80293c
  801a94:	e8 5e eb ff ff       	call   8005f7 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801a99:	83 ec 04             	sub    $0x4,%esp
  801a9c:	50                   	push   %eax
  801a9d:	68 00 50 80 00       	push   $0x805000
  801aa2:	ff 75 0c             	pushl  0xc(%ebp)
  801aa5:	e8 bc f3 ff ff       	call   800e66 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  801ac0:	53                   	push   %ebx
  801ac1:	e8 d5 f1 ff ff       	call   800c9b <strlen>
  801ac6:	83 c4 10             	add    $0x10,%esp
  801ac9:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801ace:	7f 67                	jg     801b37 <open+0x81>
		return -E_BAD_PATH;
  ...
  801ad6:	50                   	push   %eax
  801ad7:	e8 9a f8 ff ff       	call   801376 <fd_alloc>
...
sync(void)
{
  ...
  801b53:	e8 a6 fd ff ff       	call   8018fe <fsipc>
}
  801b58:	c9                   	leave  
  801b59:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b68:	e8 f2 f7 ff ff       	call   80135f <fd2data>
  801b6d:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801b6f:	83 c4 08             	add    $0x8,%esp
  801b72:	68 53 29 80 00       	push   $0x802953
  801b77:	53                   	push   %ebx
  801b78:	e8 57 f1 ff ff       	call   800cd4 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801b7d:	8b 46 04             	mov    0x4(%esi),%eax
  801b80:	2b 06                	sub    (%esi),%eax
  801b82:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801b88:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801b8f:	00 00 00 
	stat->st_dev = &devpipe;
  801b92:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801b99:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801bb5:	e8 a2 f5 ff ff       	call   80115c <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801bba:	89 1c 24             	mov    %ebx,(%esp)
  801bbd:	e8 9d f7 ff ff       	call   80135f <fd2data>
  801bc2:	83 c4 08             	add    $0x8,%esp
  801bc5:	50                   	push   %eax
  801bc6:	6a 00                	push   $0x0
  801bc8:	e8 8f f5 ff ff       	call   80115c <sys_page_unmap>
}
  801bcd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801bd0:	c9                   	leave  
  801bd1:	c3                   	ret    

00801bd2 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801bdb:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801bde:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801be0:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801be5:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801be8:	83 ec 0c             	sub    $0xc,%esp
  801beb:	ff 75 e0             	pushl  -0x20(%ebp)
  801bee:	e8 3c 05 00 00       	call   80212f <pageref>
  801bf3:	89 c3                	mov    %eax,%ebx
  801bf5:	89 3c 24             	mov    %edi,(%esp)
  801bf8:	e8 32 05 00 00       	call   80212f <pageref>
  801bfd:	83 c4 10             	add    $0x10,%esp
  801c00:	39 c3                	cmp    %eax,%ebx
  801c02:	0f 94 c1             	sete   %cl
  801c05:	0f b6 c9             	movzbl %cl,%ecx
  801c08:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801c0b:	8b 15 b0 40 80 00    	mov    0x8040b0,%edx
  801c11:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801c14:	39 ce                	cmp    %ecx,%esi
  801c16:	74 1b                	je     801c33 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801c18:	39 c3                	cmp    %eax,%ebx
  801c1a:	75 c4                	jne    801be0 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801c1c:	8b 42 58             	mov    0x58(%edx),%eax
  801c1f:	ff 75 e4             	pushl  -0x1c(%ebp)
  801c22:	50                   	push   %eax
  801c23:	56                   	push   %esi
  801c24:	68 5a 29 80 00       	push   $0x80295a
  801c29:	e8 a2 ea ff ff       	call   8006d0 <cprintf>
  801c2e:	83 c4 10             	add    $0x10,%esp
  801c31:	eb ad                	jmp    801be0 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801c4a:	56                   	push   %esi
  801c4b:	e8 0f f7 ff ff       	call   80135f <fd2data>
  ...
  801c60:	e8 6d ff ff ff       	call   801bd2 <_pipeisclosed>
  ...
  801c67:	75 48                	jne    801cb1 <devpipe_write+0x73>
			...
			sys_yield();
  801c69:	e8 4a f4 ff ff       	call   8010b8 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801cc7:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801cca:	57                   	push   %edi
  801ccb:	e8 8f f6 ff ff       	call   80135f <fd2data>
  ...
  801ce8:	e8 e5 fe ff ff       	call   801bd2 <_pipeisclosed>
  ...
  801cef:	75 32                	jne    801d23 <devpipe_read+0x65>
			...
			sys_yield();
  801cf1:	e8 c2 f3 ff ff       	call   8010b8 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801d3b:	50                   	push   %eax
  801d3c:	e8 35 f6 ff ff       	call   801376 <fd_alloc>
  ...
  801d5b:	e8 77 f3 ff ff       	call   8010d7 <sys_page_alloc>
  ...
  801d73:	50                   	push   %eax
  801d74:	e8 fd f5 ff ff       	call   801376 <fd_alloc>
  ...
  801d93:	e8 3f f3 ff ff       	call   8010d7 <sys_page_alloc>
  ...
  801dab:	e8 af f5 ff ff       	call   80135f <fd2data>
  ...
  801dbd:	e8 15 f3 ff ff       	call   8010d7 <sys_page_alloc>
  ...
  801dd5:	e8 85 f5 ff ff       	call   80135f <fd2data>
  801dda:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801de1:	50                   	push   %eax
  801de2:	6a 00                	push   $0x0
  801de4:	56                   	push   %esi
  801de5:	6a 00                	push   $0x0
  801de7:	e8 2e f3 ff ff       	call   80111a <sys_page_map>
  ...
  801e50:	e8 07 f3 ff ff       	call   80115c <sys_page_unmap>
  ...
  801e60:	e8 f7 f2 ff ff       	call   80115c <sys_page_unmap>
  ...
  801e70:	e8 e7 f2 ff ff       	call   80115c <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801e90:	e8 30 f5 ff ff       	call   8013c5 <fd_lookup>
  801e95:	83 c4 10             	add    $0x10,%esp
  801e98:	85 c0                	test   %eax,%eax
  801e9a:	78 18                	js     801eb4 <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801e9c:	83 ec 0c             	sub    $0xc,%esp
  801e9f:	ff 75 f4             	pushl  -0xc(%ebp)
  801ea2:	e8 b8 f4 ff ff       	call   80135f <fd2data>
	return _pipeisclosed(fd, p);
  801ea7:	89 c2                	mov    %eax,%edx
  801ea9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801eac:	e8 21 fd ff ff       	call   801bd2 <_pipeisclosed>
  801eb1:	83 c4 10             	add    $0x10,%esp
}
  801eb4:	c9                   	leave  
  801eb5:	c3                   	ret    

00801eb6 <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ec6:	68 72 29 80 00       	push   $0x802972
  801ecb:	ff 75 0c             	pushl  0xc(%ebp)
  801ece:	e8 01 ee ff ff       	call   800cd4 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801ede:	56                   	push   %esi
  801edf:	53                   	push   %ebx
  801ee0:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
  801ee6:	be 00 00 00 00       	mov    $0x0,%esi
		m = n - tot;
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
  ...
  801eeb:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801ef1:	eb 2d                	jmp    801f20 <devcons_write+0x46>
		m = n - tot;
  801ef3:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801ef6:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801ef8:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
  ...
  801f0a:	50                   	push   %eax
  801f0b:	57                   	push   %edi
  801f0c:	e8 55 ef ff ff       	call   800e66 <memmove>
		sys_cputs(buf, m);
  801f11:	83 c4 08             	add    $0x8,%esp
  801f14:	53                   	push   %ebx
  801f15:	57                   	push   %edi
  801f16:	e8 00 f1 ff ff       	call   80101b <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  801f25:	72 cc                	jb     801ef3 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801f3e:	74 2a                	je     801f6a <devcons_read+0x3b>
  801f40:	eb 05                	jmp    801f47 <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801f42:	e8 71 f1 ff ff       	call   8010b8 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801f47:	e8 ed f0 ff ff       	call   801039 <sys_cgetc>
  801f4c:	85 c0                	test   %eax,%eax
  801f4e:	74 f2                	je     801f42 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801f50:	85 c0                	test   %eax,%eax
  801f52:	78 16                	js     801f6a <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801f54:	83 f8 04             	cmp    $0x4,%eax
  801f57:	74 0c                	je     801f65 <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  801f59:	8b 55 0c             	mov    0xc(%ebp),%edx
  801f5c:	88 02                	mov    %al,(%edx)
	return 1;
  801f5e:	b8 01 00 00 00       	mov    $0x1,%eax
  801f63:	eb 05                	jmp    801f6a <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801f75:	88 45 f7             	mov    %al,-0x9(%ebp)

	// Unlike standard Unix's putchar,
	// the cputchar function _always_ outputs to the system console.
	sys_cputs(&c, 1);
  801f78:	6a 01                	push   $0x1
  801f7a:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801f7d:	50                   	push   %eax
  801f7e:	e8 98 f0 ff ff       	call   80101b <sys_cputs>
}
...
getchar(void)
{
  ...
  801f96:	e8 90 f6 ff ff       	call   80162b <read>
	if (r < 0)
  801f9b:	83 c4 10             	add    $0x10,%esp
  801f9e:	85 c0                	test   %eax,%eax
  801fa0:	78 0f                	js     801fb1 <getchar+0x29>
		return r;
	if (r < 1)
  801fa2:	85 c0                	test   %eax,%eax
  801fa4:	7e 06                	jle    801fac <getchar+0x24>
		return -E_EOF;
	return c;
  801fa6:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801faa:	eb 05                	jmp    801fb1 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
...
iscons(int fdnum)
{
  ...
  801fc0:	e8 00 f4 ff ff       	call   8013c5 <fd_lookup>
...
opencons(void)
{
  ...
  801fe8:	50                   	push   %eax
  801fe9:	e8 88 f3 ff ff       	call   801376 <fd_alloc>
...
opencons(void)
{
  ...
  801ff5:	78 3e                	js     802035 <opencons+0x56>
		return r;
  ...
  802004:	e8 ce f0 ff ff       	call   8010d7 <sys_page_alloc>
  ...
  802010:	78 23                	js     802035 <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  802012:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  802018:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80201b:	89 10                	mov    %edx,(%eax)
	fd->fd_omode = O_RDWR;
  80201d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802020:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  802027:	83 ec 0c             	sub    $0xc,%esp
  80202a:	50                   	push   %eax
  80202b:	e8 1f f3 ff ff       	call   80134f <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802054:	50                   	push   %eax
  802055:	e8 2d f2 ff ff       	call   801287 <sys_ipc_recv>
  80205a:	83 c4 10             	add    $0x10,%esp
  80205d:	85 c0                	test   %eax,%eax
  80205f:	79 16                	jns    802077 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  802061:	85 f6                	test   %esi,%esi
  802063:	74 06                	je     80206b <ipc_recv+0x32>
            *from_env_store = 0;
  802065:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  80206b:	85 db                	test   %ebx,%ebx
  80206d:	74 2c                	je     80209b <ipc_recv+0x62>
            *perm_store = 0;
  80206f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  802075:	eb 24                	jmp    80209b <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  802077:	85 f6                	test   %esi,%esi
  802079:	74 0a                	je     802085 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  80207b:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  802080:	8b 40 74             	mov    0x74(%eax),%eax
  802083:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  802085:	85 db                	test   %ebx,%ebx
  802087:	74 0a                	je     802093 <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  802089:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  80208e:	8b 40 78             	mov    0x78(%eax),%eax
  802091:	89 03                	mov    %eax,(%ebx)
    return thisenv->env_ipc_value;
  802093:	a1 b0 40 80 00       	mov    0x8040b0,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020ab:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  8020bb:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  8020be:	eb 1c                	jmp    8020dc <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  8020c0:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8020c3:	74 12                	je     8020d7 <ipc_send+0x35>
  8020c5:	50                   	push   %eax
  8020c6:	68 7e 29 80 00       	push   $0x80297e
  8020cb:	6a 3a                	push   $0x3a
  8020cd:	68 94 29 80 00       	push   $0x802994
  8020d2:	e8 20 e5 ff ff       	call   8005f7 <_panic>
		sys_yield();
  8020d7:	e8 dc ef ff ff       	call   8010b8 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  8020e0:	56                   	push   %esi
  8020e1:	57                   	push   %edi
  8020e2:	e8 7d f1 ff ff       	call   801264 <sys_ipc_try_send>
  8020e7:	83 c4 10             	add    $0x10,%esp
  8020ea:	85 c0                	test   %eax,%eax
  8020ec:	78 d2                	js     8020c0 <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  80210f:	75 0d                	jne    80211e <ipc_find_env+0x28>
			return envs[i].env_id;
  802111:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802114:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  802119:	8b 40 48             	mov    0x48(%eax),%eax
  80211c:	eb 0f                	jmp    80212d <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802126:	75 d9                	jne    802101 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
