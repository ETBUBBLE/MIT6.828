...
fsipc(unsigned type, void *dstva)
{
  ...
  801656:	e8 69 07 00 00       	call   801dc4 <ipc_find_env>
  ...
  801671:	e8 fa 06 00 00       	call   801d70 <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801a3f:	e8 b9 03 00 00       	call   801dfd <pageref>
  801a44:	89 c3                	mov    %eax,%ebx
  801a46:	89 3c 24             	mov    %edi,(%esp)
  801a49:	e8 af 03 00 00       	call   801dfd <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d17:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801d1c:	0f 44 c2             	cmove  %edx,%eax
    int r;
    if ((r = sys_ipc_recv(pg)) < 0) {
  801d1f:	83 ec 0c             	sub    $0xc,%esp
  801d22:	50                   	push   %eax
  801d23:	e8 27 f3 ff ff       	call   80104f <sys_ipc_recv>
  801d28:	83 c4 10             	add    $0x10,%esp
  801d2b:	85 c0                	test   %eax,%eax
  801d2d:	79 16                	jns    801d45 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801d2f:	85 f6                	test   %esi,%esi
  801d31:	74 06                	je     801d39 <ipc_recv+0x32>
            *from_env_store = 0;
  801d33:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801d39:	85 db                	test   %ebx,%ebx
  801d3b:	74 2c                	je     801d69 <ipc_recv+0x62>
            *perm_store = 0;
  801d3d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d43:	eb 24                	jmp    801d69 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801d45:	85 f6                	test   %esi,%esi
  801d47:	74 0a                	je     801d53 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801d49:	a1 04 44 80 00       	mov    0x804404,%eax
  801d4e:	8b 40 74             	mov    0x74(%eax),%eax
  801d51:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801d53:	85 db                	test   %ebx,%ebx
  801d55:	74 0a                	je     801d61 <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801d57:	a1 04 44 80 00       	mov    0x804404,%eax
  801d5c:	8b 40 78             	mov    0x78(%eax),%eax
  801d5f:	89 03                	mov    %eax,(%ebx)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d84:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801d89:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801d8c:	eb 1c                	jmp    801daa <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801d8e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d91:	74 12                	je     801da5 <ipc_send+0x35>
  801d93:	50                   	push   %eax
  801d94:	68 9e 25 80 00       	push   $0x80259e
  801d99:	6a 3a                	push   $0x3a
  801d9b:	68 b4 25 80 00       	push   $0x8025b4
  801da0:	e8 27 e5 ff ff       	call   8002cc <_panic>
		sys_yield();
  801da5:	e8 d6 f0 ff ff       	call   800e80 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801dae:	56                   	push   %esi
  801daf:	57                   	push   %edi
  801db0:	e8 77 f2 ff ff       	call   80102c <sys_ipc_try_send>
  801db5:	83 c4 10             	add    $0x10,%esp
  801db8:	85 c0                	test   %eax,%eax
  801dba:	78 d2                	js     801d8e <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
