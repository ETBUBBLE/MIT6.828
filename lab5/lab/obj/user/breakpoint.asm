...
fsipc(unsigned type, void *dstva)
{
  ...
  80090c:	e8 00 12 00 00       	call   801b11 <ipc_find_env>
  ...
  800927:	e8 91 11 00 00       	call   801abd <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800be5:	e8 60 0f 00 00       	call   801b4a <pageref>
  800bea:	89 c3                	mov    %eax,%ebx
  800bec:	89 3c 24             	mov    %edi,(%esp)
  800bef:	e8 56 0f 00 00       	call   801b4a <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a6f:	50                   	push   %eax
  801a70:	e8 90 e8 ff ff       	call   800305 <sys_ipc_recv>
  801a75:	83 c4 10             	add    $0x10,%esp
  801a78:	85 c0                	test   %eax,%eax
  801a7a:	79 16                	jns    801a92 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801a7c:	85 f6                	test   %esi,%esi
  801a7e:	74 06                	je     801a86 <ipc_recv+0x32>
            *from_env_store = 0;
  801a80:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801a86:	85 db                	test   %ebx,%ebx
  801a88:	74 2c                	je     801ab6 <ipc_recv+0x62>
            *perm_store = 0;
  801a8a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801a90:	eb 24                	jmp    801ab6 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801a92:	85 f6                	test   %esi,%esi
  801a94:	74 0a                	je     801aa0 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801a96:	a1 04 40 80 00       	mov    0x804004,%eax
  801a9b:	8b 40 74             	mov    0x74(%eax),%eax
  801a9e:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801aa0:	85 db                	test   %ebx,%ebx
  801aa2:	74 0a                	je     801aae <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801aa4:	a1 04 40 80 00       	mov    0x804004,%eax
  801aa9:	8b 40 78             	mov    0x78(%eax),%eax
  801aac:	89 03                	mov    %eax,(%ebx)
    return thisenv->env_ipc_value;
  801aae:	a1 04 40 80 00       	mov    0x804004,%eax
  801ab3:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ad1:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801ad6:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801ad9:	eb 1c                	jmp    801af7 <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801adb:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801ade:	74 12                	je     801af2 <ipc_send+0x35>
  801ae0:	50                   	push   %eax
  801ae1:	68 60 22 80 00       	push   $0x802260
  801ae6:	6a 3a                	push   $0x3a
  801ae8:	68 76 22 80 00       	push   $0x802276
  801aed:	e8 3e f5 ff ff       	call   801030 <_panic>
		sys_yield();
  801af2:	e8 3f e6 ff ff       	call   800136 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801afb:	56                   	push   %esi
  801afc:	57                   	push   %edi
  801afd:	e8 e0 e7 ff ff       	call   8002e2 <sys_ipc_try_send>
  801b02:	83 c4 10             	add    $0x10,%esp
  801b05:	85 c0                	test   %eax,%eax
  801b07:	78 d2                	js     801adb <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b2a:	75 0d                	jne    801b39 <ipc_find_env+0x28>
			return envs[i].env_id;
  801b2c:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b2f:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b34:	8b 40 48             	mov    0x48(%eax),%eax
  801b37:	eb 0f                	jmp    801b48 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b41:	75 d9                	jne    801b1c <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
