...
cat(int f, char *s)
{
  ...
  80005b:	68 20 20 80 00       	push   $0x802020
  800060:	6a 0d                	push   $0xd
  800062:	68 3b 20 80 00       	push   $0x80203b
...
cat(int f, char *s)
{
  ...
  800093:	68 46 20 80 00       	push   $0x802046
  800098:	6a 0f                	push   $0xf
  80009a:	68 3b 20 80 00       	push   $0x80203b
...
umain(int argc, char **argv)
{
  ...
  8000b4:	8b 7d 0c             	mov    0xc(%ebp),%edi
	...
	binaryname = "cat";
  8000b7:	c7 05 00 30 80 00 5b 	movl   $0x80205b,0x803000
  8000be:	20 80 00 
  ...
  8000cf:	68 5f 20 80 00       	push   $0x80205f
  ...
  8000fd:	68 67 20 80 00       	push   $0x802067
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001af:	56                   	push   %esi
  8001b0:	50                   	push   %eax
  8001b1:	68 84 20 80 00       	push   $0x802084
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cf:	e8 bc 1a 00 00       	call   801d90 <__udivdi3>
  ...
  800312:	e8 a9 1b 00 00       	call   801ec0 <__umoddi3>
  800317:	83 c4 14             	add    $0x14,%esp
  80031a:	0f be 80 a7 20 80 00 	movsbl 0x8020a7(%eax),%eax
  800321:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003dc:	ff 24 85 e0 21 80 00 	jmp    *0x8021e0(,%eax,4)
  ...
  8004a3:	8b 14 85 40 23 80 00 	mov    0x802340(,%eax,4),%edx
  8004aa:	85 d2                	test   %edx,%edx
  8004ac:	75 1b                	jne    8004c9 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  8004ae:	50                   	push   %eax
  8004af:	68 bf 20 80 00       	push   $0x8020bf
  8004b4:	53                   	push   %ebx
  8004b5:	56                   	push   %esi
  ...
  8004c9:	52                   	push   %edx
  8004ca:	68 75 24 80 00       	push   $0x802475
  8004cf:	53                   	push   %ebx
  8004d0:	56                   	push   %esi
  ...
  8004f4:	b8 b8 20 80 00       	mov    $0x8020b8,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c1c:	68 9f 23 80 00       	push   $0x80239f
  800c21:	6a 23                	push   $0x23
  800c23:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c9d:	68 9f 23 80 00       	push   $0x80239f
  800ca2:	6a 23                	push   $0x23
  800ca4:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cdf:	68 9f 23 80 00       	push   $0x80239f
  800ce4:	6a 23                	push   $0x23
  800ce6:	68 bc 23 80 00       	push   $0x8023bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d21:	68 9f 23 80 00       	push   $0x80239f
  800d26:	6a 23                	push   $0x23
  800d28:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d63:	68 9f 23 80 00       	push   $0x80239f
  800d68:	6a 23                	push   $0x23
  800d6a:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800da5:	68 9f 23 80 00       	push   $0x80239f
  800daa:	6a 23                	push   $0x23
  800dac:	68 bc 23 80 00       	push   $0x8023bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800de7:	68 9f 23 80 00       	push   $0x80239f
  800dec:	6a 23                	push   $0x23
  800dee:	68 bc 23 80 00       	push   $0x8023bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800e4b:	68 9f 23 80 00       	push   $0x80239f
  800e50:	6a 23                	push   $0x23
  800e52:	68 bc 23 80 00       	push   $0x8023bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f39:	ba 4c 24 80 00       	mov    $0x80244c,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f64:	51                   	push   %ecx
  800f65:	50                   	push   %eax
  800f66:	68 cc 23 80 00       	push   $0x8023cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80118e:	53                   	push   %ebx
  80118f:	50                   	push   %eax
  801190:	68 10 24 80 00       	push   $0x802410
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801263:	53                   	push   %ebx
  801264:	50                   	push   %eax
  801265:	68 2c 24 80 00       	push   $0x80242c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801318:	53                   	push   %ebx
  801319:	50                   	push   %eax
  80131a:	68 ec 23 80 00       	push   $0x8023ec
...
fsipc(unsigned type, void *dstva)
{
  ...
  80142a:	e8 ec 08 00 00       	call   801d1b <ipc_find_env>
  ...
  801445:	e8 7d 08 00 00       	call   801cc7 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80157b:	68 5c 24 80 00       	push   $0x80245c
  801580:	68 63 24 80 00       	push   $0x802463
  801585:	6a 7c                	push   $0x7c
  801587:	68 78 24 80 00       	push   $0x802478
  80158c:	e8 02 ec ff ff       	call   800193 <_panic>
	assert(r <= PGSIZE);
  801591:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801596:	7e 16                	jle    8015ae <devfile_read+0x65>
  801598:	68 83 24 80 00       	push   $0x802483
  80159d:	68 63 24 80 00       	push   $0x802463
  8015a2:	6a 7d                	push   $0x7d
  8015a4:	68 78 24 80 00       	push   $0x802478
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801797:	68 8f 24 80 00       	push   $0x80248f
  80179c:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801813:	e8 3c 05 00 00       	call   801d54 <pageref>
  801818:	89 c3                	mov    %eax,%ebx
  80181a:	89 3c 24             	mov    %edi,(%esp)
  80181d:	e8 32 05 00 00       	call   801d54 <pageref>
  ...
  801847:	50                   	push   %eax
  801848:	56                   	push   %esi
  801849:	68 96 24 80 00       	push   $0x802496
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801aeb:	68 ae 24 80 00       	push   $0x8024ae
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c6e:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801c73:	0f 44 c2             	cmove  %edx,%eax
    int r;
    if ((r = sys_ipc_recv(pg)) < 0) {
  801c76:	83 ec 0c             	sub    $0xc,%esp
  801c79:	50                   	push   %eax
  801c7a:	e8 a4 f1 ff ff       	call   800e23 <sys_ipc_recv>
  801c7f:	83 c4 10             	add    $0x10,%esp
  801c82:	85 c0                	test   %eax,%eax
  801c84:	79 16                	jns    801c9c <ipc_recv+0x3e>
        if (from_env_store != NULL)
  801c86:	85 f6                	test   %esi,%esi
  801c88:	74 06                	je     801c90 <ipc_recv+0x32>
            *from_env_store = 0;
  801c8a:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801c90:	85 db                	test   %ebx,%ebx
  801c92:	74 2c                	je     801cc0 <ipc_recv+0x62>
            *perm_store = 0;
  801c94:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801c9a:	eb 24                	jmp    801cc0 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801c9c:	85 f6                	test   %esi,%esi
  801c9e:	74 0a                	je     801caa <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801ca0:	a1 20 60 80 00       	mov    0x806020,%eax
  801ca5:	8b 40 74             	mov    0x74(%eax),%eax
  801ca8:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801caa:	85 db                	test   %ebx,%ebx
  801cac:	74 0a                	je     801cb8 <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801cae:	a1 20 60 80 00       	mov    0x806020,%eax
  801cb3:	8b 40 78             	mov    0x78(%eax),%eax
  801cb6:	89 03                	mov    %eax,(%ebx)
    return thisenv->env_ipc_value;
  801cb8:	a1 20 60 80 00       	mov    0x806020,%eax
  801cbd:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801cd3:	8b 75 0c             	mov    0xc(%ebp),%esi
  801cd6:	8b 45 10             	mov    0x10(%ebp),%eax
  801cd9:	85 c0                	test   %eax,%eax
  801cdb:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801ce0:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  801ce3:	eb 1c                	jmp    801d01 <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  801ce5:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801ce8:	74 12                	je     801cfc <ipc_send+0x35>
  801cea:	50                   	push   %eax
  801ceb:	68 ba 24 80 00       	push   $0x8024ba
  801cf0:	6a 3a                	push   $0x3a
  801cf2:	68 d0 24 80 00       	push   $0x8024d0
  801cf7:	e8 97 e4 ff ff       	call   800193 <_panic>
		sys_yield();
  801cfc:	e8 53 ef ff ff       	call   800c54 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  801d05:	56                   	push   %esi
  801d06:	57                   	push   %edi
  801d07:	e8 f4 f0 ff ff       	call   800e00 <sys_ipc_try_send>
  801d0c:	83 c4 10             	add    $0x10,%esp
  801d0f:	85 c0                	test   %eax,%eax
  801d11:	78 d2                	js     801ce5 <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801d26:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d29:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d2f:	8b 52 50             	mov    0x50(%edx),%edx
  801d32:	39 ca                	cmp    %ecx,%edx
  801d34:	75 0d                	jne    801d43 <ipc_find_env+0x28>
			return envs[i].env_id;
  801d36:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d39:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d3e:	8b 40 48             	mov    0x48(%eax),%eax
  801d41:	eb 0f                	jmp    801d52 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801d4b:	75 d9                	jne    801d26 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801d5c:	c1 e8 16             	shr    $0x16,%eax
  801d5f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801d6b:	f6 c1 01             	test   $0x1,%cl
  801d6e:	74 1d                	je     801d8d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801d70:	c1 ea 0c             	shr    $0xc,%edx
  801d73:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801d7a:	f6 c2 01             	test   $0x1,%dl
  801d7d:	74 0e                	je     801d8d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d7f:	c1 ea 0c             	shr    $0xc,%edx
  801d82:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801d89:	ef 
  801d8a:	0f b7 c0             	movzwl %ax,%eax
}
  801d8d:	5d                   	pop    %ebp
  801d8e:	c3                   	ret    
  801d8f:	90                   	nop
