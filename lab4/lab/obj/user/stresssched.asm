...
umain(int argc, char **argv)
{
  ...
  80003f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800044:	e8 7d 0e 00 00       	call   800ec6 <fork>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800de4:	74 2d                	je     800e13 <pgfault+0x3f>
  ...
  800df4:	74 1d                	je     800e13 <pgfault+0x3f>
  ...
  800e05:	74 0c                	je     800e13 <pgfault+0x3f>
        (uvpt[PGNUM(addr)] & PTE_P) && (uvpt[PGNUM(addr)] & PTE_COW)
  ...
  800e11:	75 14                	jne    800e27 <pgfault+0x53>
        (err & FEC_WR) && (uvpd[PDX(addr)] & PTE_P) &&
        (uvpt[PGNUM(addr)] & PTE_P) && (uvpt[PGNUM(addr)] & PTE_COW)
	)) panic("Neither the fault is a write nor copy-on-write page.\n");
  800e13:	83 ec 04             	sub    $0x4,%esp
  800e16:	68 50 16 80 00       	push   $0x801650
  800e1b:	6a 1f                	push   $0x1f
  800e1d:	68 88 16 80 00       	push   $0x801688
  ...
  800e33:	e8 ed fd ff ff       	call   800c25 <sys_page_alloc>
  800e38:	83 c4 10             	add    $0x10,%esp
  800e3b:	85 c0                	test   %eax,%eax
  800e3d:	79 12                	jns    800e51 <pgfault+0x7d>
		 panic("sys_page_alloc: %e\n", r);
  800e3f:	50                   	push   %eax
  800e40:	68 93 16 80 00       	push   $0x801693
  800e45:	6a 29                	push   $0x29
  800e47:	68 88 16 80 00       	push   $0x801688
  800e4c:	e8 f4 f2 ff ff       	call   800145 <_panic>
	}
  ...
  800e65:	e8 b2 fb ff ff       	call   800a1c <memcpy>
  ...
  800e7b:	e8 e8 fd ff ff       	call   800c68 <sys_page_map>
  800e80:	83 c4 20             	add    $0x20,%esp
  800e83:	85 c0                	test   %eax,%eax
  800e85:	79 12                	jns    800e99 <pgfault+0xc5>
        panic("sys_page_map: %e\n", r);
  800e87:	50                   	push   %eax
  800e88:	68 a7 16 80 00       	push   $0x8016a7
  800e8d:	6a 2e                	push   $0x2e
  800e8f:	68 88 16 80 00       	push   $0x801688
  800e94:	e8 ac f2 ff ff       	call   800145 <_panic>
    if ((r = sys_page_unmap(0, (void *)PFTEMP)) < 0)
  800e99:	83 ec 08             	sub    $0x8,%esp
  800e9c:	68 00 f0 7f 00       	push   $0x7ff000
  800ea1:	6a 00                	push   $0x0
  800ea3:	e8 02 fe ff ff       	call   800caa <sys_page_unmap>
  800ea8:	83 c4 10             	add    $0x10,%esp
  800eab:	85 c0                	test   %eax,%eax
  800ead:	79 12                	jns    800ec1 <pgfault+0xed>
        panic("sys_page_unmap: %e\n", r);
  800eaf:	50                   	push   %eax
  800eb0:	68 b9 16 80 00       	push   $0x8016b9
  800eb5:	6a 30                	push   $0x30
  800eb7:	68 88 16 80 00       	push   $0x801688
  800ebc:	e8 84 f2 ff ff       	call   800145 <_panic>
...
fork(void)
{
  ...
  800ecf:	68 d4 0d 80 00       	push   $0x800dd4
  800ed4:	e8 61 01 00 00       	call   80103a <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800ee8:	79 14                	jns    800efe <fork+0x38>
		panic("sys_exofork failed");
  800eea:	83 ec 04             	sub    $0x4,%esp
  800eed:	68 cd 16 80 00       	push   $0x8016cd
  800ef2:	6a 6d                	push   $0x6d
  800ef4:	68 88 16 80 00       	push   $0x801688
  800ef9:	e8 47 f2 ff ff       	call   800145 <_panic>
  800efe:	89 c7                	mov    %eax,%edi
		return cenvid;
	}
	if(cenvid>0){
  800f00:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  800f04:	0f 8e f2 00 00 00    	jle    800ffc <fork+0x136>
  800f0a:	bb 00 08 00 00       	mov    $0x800,%ebx
		for (pn=PGNUM(UTEXT); pn<PGNUM(USTACKTOP); pn++){
            if ((uvpd[pn >> 10] & PTE_P) && (uvpt[pn] & PTE_P))
  800f0f:	89 d8                	mov    %ebx,%eax
  800f11:	c1 e8 0a             	shr    $0xa,%eax
  800f14:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  800f1b:	a8 01                	test   $0x1,%al
  800f1d:	0f 84 86 00 00 00    	je     800fa9 <fork+0xe3>
  800f23:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f2a:	a8 01                	test   $0x1,%al
  800f2c:	74 7b                	je     800fa9 <fork+0xe3>
  ...
  800f3a:	a8 02                	test   $0x2,%al
  800f3c:	75 0c                	jne    800f4a <fork+0x84>
  800f3e:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f45:	f6 c4 08             	test   $0x8,%ah
  800f48:	74 3f                	je     800f89 <fork+0xc3>
  ...
  800f57:	e8 0c fd ff ff       	call   800c68 <sys_page_map>
  800f5c:	83 c4 20             	add    $0x20,%esp
  800f5f:	85 c0                	test   %eax,%eax
  800f61:	0f 88 b1 00 00 00    	js     801018 <fork+0x152>
            return r;
  ...
  800f75:	e8 ee fc ff ff       	call   800c68 <sys_page_map>
  800f7a:	83 c4 20             	add    $0x20,%esp
  800f7d:	85 c0                	test   %eax,%eax
  800f7f:	b9 00 00 00 00       	mov    $0x0,%ecx
  800f84:	0f 4f c1             	cmovg  %ecx,%eax
  800f87:	eb 1c                	jmp    800fa5 <fork+0xdf>
            return r;
	}
  ...
  800f93:	e8 d0 fc ff ff       	call   800c68 <sys_page_map>
  800f98:	83 c4 20             	add    $0x20,%esp
  800f9b:	85 c0                	test   %eax,%eax
  800f9d:	ba 00 00 00 00       	mov    $0x0,%edx
  800fa2:	0f 4f c2             	cmovg  %edx,%eax
		return cenvid;
	}
	if(cenvid>0){
		for (pn=PGNUM(UTEXT); pn<PGNUM(USTACKTOP); pn++){
  ...
  800fa7:	78 6f                	js     801018 <fork+0x152>
	if ((cenvid = sys_exofork()) < 0){
		panic("sys_exofork failed");
		return cenvid;
	}
  ...
  800fb2:	0f 85 57 ff ff ff    	jne    800f0f <fork+0x49>
            if ((uvpd[pn >> 10] & PTE_P) && (uvpt[pn] & PTE_P))
                if ((r = duppage(cenvid, pn)) < 0)
                    return r;
		}
  ...
  800fc5:	57                   	push   %edi
  800fc6:	e8 5a fc ff ff       	call   800c25 <sys_page_alloc>
  800fcb:	83 c4 10             	add    $0x10,%esp
  800fce:	85 c0                	test   %eax,%eax
  800fd0:	78 46                	js     801018 <fork+0x152>
            return r;
		extern void _pgfault_upcall(void);
		if ((r = sys_env_set_pgfault_upcall(cenvid, _pgfault_upcall)) < 0)
  800fd2:	83 ec 08             	sub    $0x8,%esp
  800fd5:	68 9d 10 80 00       	push   $0x80109d
  800fda:	57                   	push   %edi
  800fdb:	e8 4e fd ff ff       	call   800d2e <sys_env_set_pgfault_upcall>
  800fe0:	83 c4 10             	add    $0x10,%esp
  800fe3:	85 c0                	test   %eax,%eax
  800fe5:	78 31                	js     801018 <fork+0x152>
            return r;
		if ((r = sys_env_set_status(cenvid, ENV_RUNNABLE)) < 0)
  800fe7:	83 ec 08             	sub    $0x8,%esp
  800fea:	6a 02                	push   $0x2
  800fec:	57                   	push   %edi
  800fed:	e8 fa fc ff ff       	call   800cec <sys_env_set_status>
  800ff2:	83 c4 10             	add    $0x10,%esp
            return r;
        return cenvid;
  800ff5:	85 c0                	test   %eax,%eax
  800ff7:	0f 49 c7             	cmovns %edi,%eax
  800ffa:	eb 1c                	jmp    801018 <fork+0x152>
	}
	else {
		thisenv = &envs[ENVX(sys_getenvid())];
  800ffc:	e8 e6 fb ff ff       	call   800be7 <sys_getenvid>
  801001:	25 ff 03 00 00       	and    $0x3ff,%eax
  801006:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801009:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80100e:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
...
sfork(void)
{
  ...
  801026:	68 e0 16 80 00       	push   $0x8016e0
  80102b:	68 8b 00 00 00       	push   $0x8b
  801030:	68 88 16 80 00       	push   $0x801688
  801035:	e8 0b f1 ff ff       	call   800145 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801040:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  801047:	75 4a                	jne    801093 <set_pgfault_handler+0x59>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP - PGSIZE), PTE_P | PTE_W | PTE_U)) < 0)
  801049:	a1 08 20 80 00       	mov    0x802008,%eax
  80104e:	8b 40 48             	mov    0x48(%eax),%eax
  801051:	83 ec 04             	sub    $0x4,%esp
  801054:	6a 07                	push   $0x7
  801056:	68 00 f0 bf ee       	push   $0xeebff000
  80105b:	50                   	push   %eax
  80105c:	e8 c4 fb ff ff       	call   800c25 <sys_page_alloc>
  801061:	83 c4 10             	add    $0x10,%esp
  801064:	85 c0                	test   %eax,%eax
  801066:	79 12                	jns    80107a <set_pgfault_handler+0x40>
           	panic("set_pgfault_handler: %e", r);
  801068:	50                   	push   %eax
  801069:	68 f6 16 80 00       	push   $0x8016f6
  80106e:	6a 21                	push   $0x21
  801070:	68 0e 17 80 00       	push   $0x80170e
  801075:	e8 cb f0 ff ff       	call   800145 <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  80107a:	a1 08 20 80 00       	mov    0x802008,%eax
  80107f:	8b 40 48             	mov    0x48(%eax),%eax
  801082:	83 ec 08             	sub    $0x8,%esp
  801085:	68 9d 10 80 00       	push   $0x80109d
  80108a:	50                   	push   %eax
  80108b:	e8 9e fc ff ff       	call   800d2e <sys_env_set_pgfault_upcall>
...
_pgfault_upcall:
  ...
  80109e:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  8010af:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  8010b4:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
