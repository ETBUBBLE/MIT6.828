...
_pgfault_upcall:
  ...
  80031f:	83 c4 04             	add    $0x4,%esp
	...
	addl $8, %esp
  800322:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  800325:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  800329:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  80032e:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036a:	e8 54 00 00 00       	call   8003c3 <vcprintf>
	cprintf("\n");
  80036f:	c7 04 24 bc 10 80 00 	movl   $0x8010bc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004c2:	0f be 80 be 10 80 00 	movsbl 0x8010be(%eax),%eax
  8004c9:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800656:	50                   	push   %eax
  800657:	68 d6 10 80 00       	push   $0x8010d6
  80065c:	53                   	push   %ebx
  80065d:	56                   	push   %esi
  ...
  800671:	52                   	push   %edx
  800672:	68 df 10 80 00       	push   $0x8010df
  800677:	53                   	push   %ebx
  800678:	56                   	push   %esi
  ...
  80069c:	b8 cf 10 80 00       	mov    $0x8010cf,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d6c:	75 4a                	jne    800db8 <set_pgfault_handler+0x59>
		// First time through!
		// LAB 4: Your code here.
  ...
  800d80:	50                   	push   %eax
  800d81:	e8 e2 f3 ff ff       	call   800168 <sys_page_alloc>
  800d86:	83 c4 10             	add    $0x10,%esp
  800d89:	85 c0                	test   %eax,%eax
  800d8b:	79 12                	jns    800d9f <set_pgfault_handler+0x40>
           	panic("set_pgfault_handler: %e", r);
  800d8d:	50                   	push   %eax
  800d8e:	68 04 13 80 00       	push   $0x801304
  800d93:	6a 21                	push   $0x21
  800d95:	68 1c 13 80 00       	push   $0x80131c
  800d9a:	e8 9c f5 ff ff       	call   80033b <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800d9f:	a1 04 20 80 00       	mov    0x802004,%eax
  800da4:	8b 40 48             	mov    0x48(%eax),%eax
  800da7:	83 ec 08             	sub    $0x8,%esp
  800daa:	68 17 03 80 00       	push   $0x800317
  800daf:	50                   	push   %eax
  800db0:	e8 bc f4 ff ff       	call   800271 <sys_env_set_pgfault_upcall>
  ...
  800dbb:	a3 08 20 80 00       	mov    %eax,0x802008
  800dc0:	c9                   	leave  
  800dc1:	c3                   	ret    
