...
sys_env_destroy(envid_t envid)
{
  ...
  800b27:	e8 7c 02 00 00       	call   800da8 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ba8:	e8 fb 01 00 00       	call   800da8 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bea:	e8 b9 01 00 00       	call   800da8 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c2c:	e8 77 01 00 00       	call   800da8 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c6e:	e8 35 01 00 00       	call   800da8 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cb0:	e8 f3 00 00 00       	call   800da8 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d14:	e8 8f 00 00 00       	call   800da8 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2e:	75 4a                	jne    800d7a <set_pgfault_handler+0x59>
		// First time through!
  ...
  800d4f:	50                   	push   %eax
  800d50:	68 0f 13 80 00       	push   $0x80130f
  800d55:	6a 21                	push   $0x21
  800d57:	68 27 13 80 00       	push   $0x801327
  800d5c:	e8 47 00 00 00       	call   800da8 <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800d61:	a1 04 20 80 00       	mov    0x802004,%eax
  800d66:	8b 40 48             	mov    0x48(%eax),%eax
  800d69:	83 ec 08             	sub    $0x8,%esp
  800d6c:	68 84 0d 80 00       	push   $0x800d84
  800d71:	50                   	push   %eax
  ...
  800d7d:	a3 08 20 80 00       	mov    %eax,0x802008
  800d82:	c9                   	leave  
  800d83:	c3                   	ret    

00800d84 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800d85:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800d8a:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800d8c:	83 c4 04             	add    $0x4,%esp
  ...
  800d8f:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  800d92:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  800d96:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  800d9b:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800db6:	e8 79 fd ff ff       	call   800b34 <sys_getenvid>
  800dbb:	83 ec 0c             	sub    $0xc,%esp
  800dbe:	ff 75 0c             	pushl  0xc(%ebp)
  800dc1:	ff 75 08             	pushl  0x8(%ebp)
  800dc4:	56                   	push   %esi
  800dc5:	50                   	push   %eax
  800dc6:	68 38 13 80 00       	push   $0x801338
  800dcb:	e8 9b f3 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800dd0:	83 c4 18             	add    $0x18,%esp
  800dd3:	53                   	push   %ebx
  800dd4:	ff 75 10             	pushl  0x10(%ebp)
  800dd7:	e8 3e f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800ddc:	c7 04 24 9a 10 80 00 	movl   $0x80109a,(%esp)
  800de3:	e8 83 f3 ff ff       	call   80016b <cprintf>
  800de8:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800deb:	cc                   	int3   
  800dec:	eb fd                	jmp    800deb <_panic+0x43>
