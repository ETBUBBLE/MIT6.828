	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80072b:	e8 e0 0b 00 00       	call   801310 <__udivdi3>
  ...
  80076e:	e8 cd 0c 00 00       	call   801440 <__umoddi3>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80128b:	75 4a                	jne    8012d7 <set_pgfault_handler+0x59>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP - PGSIZE), PTE_P | PTE_W | PTE_U)) < 0)
  80128d:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  ...
  8012b2:	6a 21                	push   $0x21
  8012b4:	68 67 19 80 00       	push   $0x801967
  8012b9:	e8 31 f3 ff ff       	call   8005ef <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  8012be:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  8012c3:	8b 40 48             	mov    0x48(%eax),%eax
  8012c6:	83 ec 08             	sub    $0x8,%esp
  8012c9:	68 e1 12 80 00       	push   $0x8012e1
  8012ce:	50                   	push   %eax
  ...
  8012da:	a3 d0 20 80 00       	mov    %eax,0x8020d0
  8012df:	c9                   	leave  
  8012e0:	c3                   	ret    

008012e1 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  8012e2:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  8012ec:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  8012ef:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  8012f3:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  8012f8:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
