...
top:
  ...
  800046:	56                   	push   %esi
  800047:	e8 f9 0f 00 00       	call   801045 <ipc_recv>
  ...
  800060:	e8 c4 01 00 00       	call   800229 <cprintf>
	...
	if ((id = fork()) < 0)
  800065:	e8 67 0e 00 00       	call   800ed1 <fork>
  ...
  800093:	56                   	push   %esi
  800094:	e8 ac 0f 00 00       	call   801045 <ipc_recv>
  ...
  8000a9:	51                   	push   %ecx
  8000aa:	57                   	push   %edi
  8000ab:	e8 fe 0f 00 00       	call   8010ae <ipc_send>
...
umain(int argc, char **argv)
{
  ...
  8000b9:	53                   	push   %ebx
	...
	if ((id = fork()) < 0)
  8000ba:	e8 12 0e 00 00       	call   800ed1 <fork>
  ...
  8000e9:	53                   	push   %ebx
  8000ea:	56                   	push   %esi
  8000eb:	e8 be 0f 00 00       	call   8010ae <ipc_send>
		panic("fork: %e", id);
	if (id == 0)
		primeproc();
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017f:	e8 54 00 00 00       	call   8001d8 <vcprintf>
	cprintf("\n");
  800184:	c7 04 24 85 17 80 00 	movl   $0x801785,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e21:	68 30 17 80 00       	push   $0x801730
  800e26:	6a 1f                	push   $0x1f
  800e28:	68 68 17 80 00       	push   $0x801768
  ...
  800e3e:	e8 ed fd ff ff       	call   800c30 <sys_page_alloc>
  800e43:	83 c4 10             	add    $0x10,%esp
  800e46:	85 c0                	test   %eax,%eax
  800e48:	79 12                	jns    800e5c <pgfault+0x7d>
		 panic("sys_page_alloc: %e\n", r);
  800e4a:	50                   	push   %eax
  800e4b:	68 73 17 80 00       	push   $0x801773
  800e50:	6a 29                	push   $0x29
  800e52:	68 68 17 80 00       	push   $0x801768
  800e57:	e8 f4 f2 ff ff       	call   800150 <_panic>
	}
  ...
  800e70:	e8 b2 fb ff ff       	call   800a27 <memcpy>
...
fork(void)
{
  ...
  800edf:	e8 57 02 00 00       	call   80113b <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800ef8:	68 ad 17 80 00       	push   $0x8017ad
  800efd:	6a 6d                	push   $0x6d
  800eff:	68 68 17 80 00       	push   $0x801768
  800f04:	e8 47 f2 ff ff       	call   800150 <_panic>
  800f09:	89 c7                	mov    %eax,%edi
		return cenvid;
	}
	if(cenvid>0){
  800f0b:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  800f0f:	0f 8e f2 00 00 00    	jle    801007 <fork+0x136>
  ...
  800f28:	0f 84 86 00 00 00    	je     800fb4 <fork+0xe3>
  800f2e:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f35:	a8 01                	test   $0x1,%al
  800f37:	74 7b                	je     800fb4 <fork+0xe3>
  ...
  800f45:	a8 02                	test   $0x2,%al
  800f47:	75 0c                	jne    800f55 <fork+0x84>
  800f49:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f50:	f6 c4 08             	test   $0x8,%ah
  800f53:	74 3f                	je     800f94 <fork+0xc3>
  ...
  800f62:	e8 0c fd ff ff       	call   800c73 <sys_page_map>
  800f67:	83 c4 20             	add    $0x20,%esp
  800f6a:	85 c0                	test   %eax,%eax
  800f6c:	0f 88 b1 00 00 00    	js     801023 <fork+0x152>
            return r;
  ...
  800f80:	e8 ee fc ff ff       	call   800c73 <sys_page_map>
  800f85:	83 c4 20             	add    $0x20,%esp
  800f88:	85 c0                	test   %eax,%eax
  800f8a:	b9 00 00 00 00       	mov    $0x0,%ecx
  800f8f:	0f 4f c1             	cmovg  %ecx,%eax
  800f92:	eb 1c                	jmp    800fb0 <fork+0xdf>
            return r;
	}
  ...
  800f9e:	e8 d0 fc ff ff       	call   800c73 <sys_page_map>
  ...
  800fb2:	78 6f                	js     801023 <fork+0x152>
	if ((cenvid = sys_exofork()) < 0){
		panic("sys_exofork failed");
		return cenvid;
	}
  ...
  800fbd:	0f 85 57 ff ff ff    	jne    800f1a <fork+0x49>
            if ((uvpd[pn >> 10] & PTE_P) && (uvpt[pn] & PTE_P))
                if ((r = duppage(cenvid, pn)) < 0)
                    return r;
		}
  ...
  800fcd:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  800fd0:	57                   	push   %edi
  800fd1:	e8 5a fc ff ff       	call   800c30 <sys_page_alloc>
  800fd6:	83 c4 10             	add    $0x10,%esp
  800fd9:	85 c0                	test   %eax,%eax
  800fdb:	78 46                	js     801023 <fork+0x152>
            return r;
		extern void _pgfault_upcall(void);
		if ((r = sys_env_set_pgfault_upcall(cenvid, _pgfault_upcall)) < 0)
  800fdd:	83 ec 08             	sub    $0x8,%esp
  800fe0:	68 9e 11 80 00       	push   $0x80119e
  800fe5:	57                   	push   %edi
  800fe6:	e8 4e fd ff ff       	call   800d39 <sys_env_set_pgfault_upcall>
  800feb:	83 c4 10             	add    $0x10,%esp
  800fee:	85 c0                	test   %eax,%eax
  800ff0:	78 31                	js     801023 <fork+0x152>
            return r;
		if ((r = sys_env_set_status(cenvid, ENV_RUNNABLE)) < 0)
  800ff2:	83 ec 08             	sub    $0x8,%esp
  800ff5:	6a 02                	push   $0x2
  800ff7:	57                   	push   %edi
  800ff8:	e8 fa fc ff ff       	call   800cf7 <sys_env_set_status>
  800ffd:	83 c4 10             	add    $0x10,%esp
            return r;
        return cenvid;
  801000:	85 c0                	test   %eax,%eax
  801002:	0f 49 c7             	cmovns %edi,%eax
  801005:	eb 1c                	jmp    801023 <fork+0x152>
	}
	else {
		thisenv = &envs[ENVX(sys_getenvid())];
  801007:	e8 e6 fb ff ff       	call   800bf2 <sys_getenvid>
  80100c:	25 ff 03 00 00       	and    $0x3ff,%eax
  801011:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801014:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801019:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
...
sfork(void)
{
  ...
  801031:	68 c0 17 80 00       	push   $0x8017c0
  801036:	68 8b 00 00 00       	push   $0x8b
  80103b:	68 68 17 80 00       	push   $0x801768
  801040:	e8 0b f1 ff ff       	call   800150 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801055:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  80105a:	0f 44 c2             	cmove  %edx,%eax
    int r;
    if ((r = sys_ipc_recv(pg)) < 0) {
  80105d:	83 ec 0c             	sub    $0xc,%esp
  801060:	50                   	push   %eax
  801061:	e8 38 fd ff ff       	call   800d9e <sys_ipc_recv>
  801066:	83 c4 10             	add    $0x10,%esp
  801069:	85 c0                	test   %eax,%eax
  80106b:	79 16                	jns    801083 <ipc_recv+0x3e>
        if (from_env_store != NULL)
  80106d:	85 f6                	test   %esi,%esi
  80106f:	74 06                	je     801077 <ipc_recv+0x32>
            *from_env_store = 0;
  801071:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
        if (perm_store != NULL)
  801077:	85 db                	test   %ebx,%ebx
  801079:	74 2c                	je     8010a7 <ipc_recv+0x62>
            *perm_store = 0;
  80107b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801081:	eb 24                	jmp    8010a7 <ipc_recv+0x62>
        return r;
    }
    if (from_env_store != NULL)
  801083:	85 f6                	test   %esi,%esi
  801085:	74 0a                	je     801091 <ipc_recv+0x4c>
        *from_env_store = thisenv->env_ipc_from;
  801087:	a1 04 20 80 00       	mov    0x802004,%eax
  80108c:	8b 40 74             	mov    0x74(%eax),%eax
  80108f:	89 06                	mov    %eax,(%esi)
    if (perm_store != NULL)
  801091:	85 db                	test   %ebx,%ebx
  801093:	74 0a                	je     80109f <ipc_recv+0x5a>
        *perm_store = thisenv->env_ipc_perm;
  801095:	a1 04 20 80 00       	mov    0x802004,%eax
  80109a:	8b 40 78             	mov    0x78(%eax),%eax
  80109d:	89 03                	mov    %eax,(%ebx)
    return thisenv->env_ipc_value;
  80109f:	a1 04 20 80 00       	mov    0x802004,%eax
  8010a4:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8010c2:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  8010c7:	0f 45 d8             	cmovne %eax,%ebx
	// LAB 4: Your code here.
	int r;
	while((r=sys_ipc_try_send(to_env,val, (pg == NULL ? (void *)UTOP : pg),perm))<0){
  8010ca:	eb 1c                	jmp    8010e8 <ipc_send+0x3a>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
  8010cc:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8010cf:	74 12                	je     8010e3 <ipc_send+0x35>
  8010d1:	50                   	push   %eax
  8010d2:	68 d6 17 80 00       	push   $0x8017d6
  8010d7:	6a 3a                	push   $0x3a
  8010d9:	68 ec 17 80 00       	push   $0x8017ec
  8010de:	e8 6d f0 ff ff       	call   800150 <_panic>
		sys_yield();
  8010e3:	e8 29 fb ff ff       	call   800c11 <sys_yield>
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 4: Your code here.
  ...
  8010ec:	56                   	push   %esi
  8010ed:	57                   	push   %edi
  8010ee:	e8 88 fc ff ff       	call   800d7b <sys_ipc_try_send>
  8010f3:	83 c4 10             	add    $0x10,%esp
  8010f6:	85 c0                	test   %eax,%eax
  8010f8:	78 d2                	js     8010cc <ipc_send+0x1e>
		if(r!=-E_IPC_NOT_RECV)panic("sys_ipc_try_send: %e\n", r);
		sys_yield();
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  80112d:	3d 00 04 00 00       	cmp    $0x400,%eax
  801132:	75 d9                	jne    80110d <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801141:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801148:	75 4a                	jne    801194 <set_pgfault_handler+0x59>
		// First time through!
		// LAB 4: Your code here.
		if ((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP - PGSIZE), PTE_P | PTE_W | PTE_U)) < 0)
  80114a:	a1 04 20 80 00       	mov    0x802004,%eax
  80114f:	8b 40 48             	mov    0x48(%eax),%eax
  801152:	83 ec 04             	sub    $0x4,%esp
  801155:	6a 07                	push   $0x7
  801157:	68 00 f0 bf ee       	push   $0xeebff000
  80115c:	50                   	push   %eax
  80115d:	e8 ce fa ff ff       	call   800c30 <sys_page_alloc>
  801162:	83 c4 10             	add    $0x10,%esp
  801165:	85 c0                	test   %eax,%eax
  801167:	79 12                	jns    80117b <set_pgfault_handler+0x40>
           	panic("set_pgfault_handler: %e", r);
  801169:	50                   	push   %eax
  80116a:	68 f6 17 80 00       	push   $0x8017f6
  80116f:	6a 21                	push   $0x21
  801171:	68 0e 18 80 00       	push   $0x80180e
  801176:	e8 d5 ef ff ff       	call   800150 <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  80117b:	a1 04 20 80 00       	mov    0x802004,%eax
  801180:	8b 40 48             	mov    0x48(%eax),%eax
  801183:	83 ec 08             	sub    $0x8,%esp
  801186:	68 9e 11 80 00       	push   $0x80119e
  80118b:	50                   	push   %eax
  80118c:	e8 a8 fb ff ff       	call   800d39 <sys_env_set_pgfault_upcall>
  ...
  801197:	a3 08 20 80 00       	mov    %eax,0x802008
  80119c:	c9                   	leave  
  80119d:	c3                   	ret    

0080119e <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80119f:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  8011a9:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  8011ac:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  8011b0:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  8011b5:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
