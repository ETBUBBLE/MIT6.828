...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800da9:	75 4a                	jne    800df5 <set_pgfault_handler+0x59>
		// First time through!
  ...
  800dca:	50                   	push   %eax
  800dcb:	68 cf 13 80 00       	push   $0x8013cf
  800dd0:	6a 21                	push   $0x21
  800dd2:	68 e7 13 80 00       	push   $0x8013e7
  ...
  800de7:	68 ff 0d 80 00       	push   $0x800dff
  800dec:	50                   	push   %eax
  ...
  800df8:	a3 08 20 80 00       	mov    %eax,0x802008
  800dfd:	c9                   	leave  
  800dfe:	c3                   	ret    

00800dff <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e00:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800e05:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800e07:	83 c4 04             	add    $0x4,%esp
  ...
  800e0a:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  800e0d:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  800e11:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
  800e16:	8b 54 24 28          	mov    0x28(%esp),%edx
    movl %eax, (%edx)
