...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dbe:	75 4a                	jne    800e0a <set_pgfault_handler+0x59>
		// First time through!
  ...
  800de5:	6a 21                	push   $0x21
  800de7:	68 07 14 80 00       	push   $0x801407
  800dec:	e8 31 f3 ff ff       	call   800122 <_panic>
        sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800df1:	a1 04 20 80 00       	mov    0x802004,%eax
  800df6:	8b 40 48             	mov    0x48(%eax),%eax
  800df9:	83 ec 08             	sub    $0x8,%esp
  800dfc:	68 14 0e 80 00       	push   $0x800e14
  800e01:	50                   	push   %eax
  ...
  800e0d:	a3 08 20 80 00       	mov    %eax,0x802008
  800e12:	c9                   	leave  
  800e13:	c3                   	ret    
...
_pgfault_upcall:
  ...
  800e1f:	83 c4 08             	add    $0x8,%esp
    movl 0x20(%esp), %eax
  800e22:	8b 44 24 20          	mov    0x20(%esp),%eax
    subl $4, 0x28(%esp) // reserve 32bit space for trap time eip
  800e26:	83 6c 24 28 04       	subl   $0x4,0x28(%esp)
    movl 0x28(%esp), %edx
