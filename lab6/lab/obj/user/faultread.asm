	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 08 23 80 00 	movsbl 0x802308(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002b1:	ff 24 85 40 24 80 00 	jmp    *0x802440(,%eax,4)
  ...
  800378:	8b 14 85 a0 25 80 00 	mov    0x8025a0(,%eax,4),%edx
  80037f:	85 d2                	test   %edx,%edx
  800381:	75 1b                	jne    80039e <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800383:	50                   	push   %eax
  800384:	68 20 23 80 00       	push   $0x802320
  800389:	53                   	push   %ebx
  80038a:	56                   	push   %esi
  ...
  80039e:	52                   	push   %edx
  80039f:	68 d5 26 80 00       	push   $0x8026d5
  8003a4:	53                   	push   %ebx
  8003a5:	56                   	push   %esi
  ...
  8003c9:	b8 19 23 80 00       	mov    $0x802319,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800af1:	68 ff 25 80 00       	push   $0x8025ff
  800af6:	6a 23                	push   $0x23
  800af8:	68 1c 26 80 00       	push   $0x80261c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b72:	68 ff 25 80 00       	push   $0x8025ff
  800b77:	6a 23                	push   $0x23
  800b79:	68 1c 26 80 00       	push   $0x80261c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bb4:	68 ff 25 80 00       	push   $0x8025ff
  800bb9:	6a 23                	push   $0x23
  800bbb:	68 1c 26 80 00       	push   $0x80261c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bf6:	68 ff 25 80 00       	push   $0x8025ff
  800bfb:	6a 23                	push   $0x23
  800bfd:	68 1c 26 80 00       	push   $0x80261c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c38:	68 ff 25 80 00       	push   $0x8025ff
  800c3d:	6a 23                	push   $0x23
  800c3f:	68 1c 26 80 00       	push   $0x80261c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c7a:	68 ff 25 80 00       	push   $0x8025ff
  800c7f:	6a 23                	push   $0x23
  800c81:	68 1c 26 80 00       	push   $0x80261c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbc:	68 ff 25 80 00       	push   $0x8025ff
  800cc1:	6a 23                	push   $0x23
  800cc3:	68 1c 26 80 00       	push   $0x80261c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d20:	68 ff 25 80 00       	push   $0x8025ff
  800d25:	6a 23                	push   $0x23
  800d27:	68 1c 26 80 00       	push   $0x80261c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e4d:	ba a8 26 80 00       	mov    $0x8026a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e78:	51                   	push   %ecx
  800e79:	50                   	push   %eax
  800e7a:	68 2c 26 80 00       	push   $0x80262c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010a2:	53                   	push   %ebx
  8010a3:	50                   	push   %eax
  8010a4:	68 6d 26 80 00       	push   $0x80266d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801177:	53                   	push   %ebx
  801178:	50                   	push   %eax
  801179:	68 89 26 80 00       	push   $0x802689
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80122c:	53                   	push   %ebx
  80122d:	50                   	push   %eax
  80122e:	68 4c 26 80 00       	push   $0x80264c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80148f:	68 bc 26 80 00       	push   $0x8026bc
  801494:	68 c3 26 80 00       	push   $0x8026c3
  801499:	6a 7c                	push   $0x7c
  80149b:	68 d8 26 80 00       	push   $0x8026d8
  8014a0:	e8 24 0a 00 00       	call   801ec9 <_panic>
	assert(r <= PGSIZE);
  8014a5:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8014aa:	7e 16                	jle    8014c2 <devfile_read+0x65>
  8014ac:	68 e3 26 80 00       	push   $0x8026e3
  8014b1:	68 c3 26 80 00       	push   $0x8026c3
  8014b6:	6a 7d                	push   $0x7d
  8014b8:	68 d8 26 80 00       	push   $0x8026d8
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801589:	68 ef 26 80 00       	push   $0x8026ef
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80192f:	68 fb 26 80 00       	push   $0x8026fb
  801934:	68 c3 26 80 00       	push   $0x8026c3
  801939:	6a 62                	push   $0x62
  80193b:	68 10 27 80 00       	push   $0x802710
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80197c:	68 1c 27 80 00       	push   $0x80271c
  801981:	68 c3 26 80 00       	push   $0x8026c3
  801986:	6a 6d                	push   $0x6d
  801988:	68 10 27 80 00       	push   $0x802710
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a02:	68 28 27 80 00       	push   $0x802728
  801a07:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801ab2:	50                   	push   %eax
  801ab3:	56                   	push   %esi
  801ab4:	68 2f 27 80 00       	push   $0x80272f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d56:	68 47 27 80 00       	push   $0x802747
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ee5:	56                   	push   %esi
  801ee6:	50                   	push   %eax
  801ee7:	68 54 27 80 00       	push   $0x802754
  ...
  801ef8:	e8 f3 e1 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801efd:	c7 04 24 fc 22 80 00 	movl   $0x8022fc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f9b:	50                   	push   %eax
  801f9c:	68 78 27 80 00       	push   $0x802778
  801fa1:	6a 3b                	push   $0x3b
  801fa3:	68 8e 27 80 00       	push   $0x80278e
