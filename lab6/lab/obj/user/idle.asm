...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 e0 	movl   $0x8022e0,0x803000
  800040:	22 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 ef 22 80 00       	push   $0x8022ef
  800114:	6a 23                	push   $0x23
  800116:	68 0c 23 80 00       	push   $0x80230c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 ef 22 80 00       	push   $0x8022ef
  800195:	6a 23                	push   $0x23
  800197:	68 0c 23 80 00       	push   $0x80230c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 ef 22 80 00       	push   $0x8022ef
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 0c 23 80 00       	push   $0x80230c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 ef 22 80 00       	push   $0x8022ef
  800219:	6a 23                	push   $0x23
  80021b:	68 0c 23 80 00       	push   $0x80230c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 ef 22 80 00       	push   $0x8022ef
  80025b:	6a 23                	push   $0x23
  80025d:	68 0c 23 80 00       	push   $0x80230c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 ef 22 80 00       	push   $0x8022ef
  80029d:	6a 23                	push   $0x23
  80029f:	68 0c 23 80 00       	push   $0x80230c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 ef 22 80 00       	push   $0x8022ef
  8002df:	6a 23                	push   $0x23
  8002e1:	68 0c 23 80 00       	push   $0x80230c
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 ef 22 80 00       	push   $0x8022ef
  800343:	6a 23                	push   $0x23
  800345:	68 0c 23 80 00       	push   $0x80230c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80046b:	ba 98 23 80 00       	mov    $0x802398,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800496:	51                   	push   %ecx
  800497:	50                   	push   %eax
  800498:	68 1c 23 80 00       	push   $0x80231c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c0:	53                   	push   %ebx
  8006c1:	50                   	push   %eax
  8006c2:	68 5d 23 80 00       	push   $0x80235d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800795:	53                   	push   %ebx
  800796:	50                   	push   %eax
  800797:	68 79 23 80 00       	push   $0x802379
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80084a:	53                   	push   %ebx
  80084b:	50                   	push   %eax
  80084c:	68 3c 23 80 00       	push   $0x80233c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800aad:	68 ac 23 80 00       	push   $0x8023ac
  800ab2:	68 b3 23 80 00       	push   $0x8023b3
  800ab7:	6a 7c                	push   $0x7c
  800ab9:	68 c8 23 80 00       	push   $0x8023c8
  800abe:	e8 24 0a 00 00       	call   8014e7 <_panic>
	assert(r <= PGSIZE);
  800ac3:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ac8:	7e 16                	jle    800ae0 <devfile_read+0x65>
  800aca:	68 d3 23 80 00       	push   $0x8023d3
  800acf:	68 b3 23 80 00       	push   $0x8023b3
  800ad4:	6a 7d                	push   $0x7d
  800ad6:	68 c8 23 80 00       	push   $0x8023c8
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ba7:	68 df 23 80 00       	push   $0x8023df
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f4d:	68 eb 23 80 00       	push   $0x8023eb
  800f52:	68 b3 23 80 00       	push   $0x8023b3
  800f57:	6a 62                	push   $0x62
  800f59:	68 00 24 80 00       	push   $0x802400
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800f9a:	68 0c 24 80 00       	push   $0x80240c
  800f9f:	68 b3 23 80 00       	push   $0x8023b3
  800fa4:	6a 6d                	push   $0x6d
  800fa6:	68 00 24 80 00       	push   $0x802400
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801020:	68 18 24 80 00       	push   $0x802418
  801025:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8010d0:	50                   	push   %eax
  8010d1:	56                   	push   %esi
  8010d2:	68 1f 24 80 00       	push   $0x80241f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801374:	68 37 24 80 00       	push   $0x802437
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801503:	56                   	push   %esi
  801504:	50                   	push   %eax
  801505:	68 44 24 80 00       	push   $0x802444
  ...
  801516:	e8 54 00 00 00       	call   80156f <vcprintf>
	cprintf("\n");
  80151b:	c7 04 24 30 24 80 00 	movl   $0x802430,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80166e:	0f be 80 67 24 80 00 	movsbl 0x802467(%eax),%eax
  801675:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801802:	50                   	push   %eax
  801803:	68 7f 24 80 00       	push   $0x80247f
  801808:	53                   	push   %ebx
  801809:	56                   	push   %esi
  ...
  80181d:	52                   	push   %edx
  80181e:	68 c5 23 80 00       	push   $0x8023c5
  801823:	53                   	push   %ebx
  801824:	56                   	push   %esi
  ...
  801848:	b8 78 24 80 00       	mov    $0x802478,%eax
